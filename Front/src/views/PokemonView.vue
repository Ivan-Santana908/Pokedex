<template>
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      <!-- Pokemon Grid -->
      <div v-if="!pokemonStore.loading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
        <pokemon-card
      ...
      <!-- Empty State -->
      <div v-if="!pokemonStore.loading && sortedPokemon.length === 0" class="text-center py-16">
      ...
      <!-- Pagination -->
      <div v-if="!pokemonStore.loading && sortedPokemon.length > 0" class="flex justify-center gap-4 mt-8">
        <button
          @click="previousPage"
...
const sortedPokemon = computed(() => {
  let result = [...pokemonStore.filteredPokemon]
